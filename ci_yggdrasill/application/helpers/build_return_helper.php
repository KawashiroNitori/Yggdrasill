...
function build_return($err_str, $other_args = NULL)
{
    ...
    (
        ...
        'illegal_char_in_username'=>array('errcode'=>29989, 'errmsg'=>'用户名中只能含有数字、英文字母或下划线。'),
        'too_long_password'=>array('errcode'=>29990, 'errmsg'=>'密码太长。'),
        'too_long_username'=>array('errcode'=>29991, 'errmsg'=>'用户名太长。'),
